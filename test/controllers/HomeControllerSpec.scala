...
class HomeControllerSpec extends PlaySpec with GuiceOneAppPerTest with Injecting with MockitoSugar {
  ...
  val mockDailySummaryService: CovidDataService = mock[CovidDataService]

  "HomeController GET" should {

    "render the index page from a new instance of controller" in {
      val controller = new HomeController(stubControllerComponents(), mockDailySummaryService, mockExecutionContext)
